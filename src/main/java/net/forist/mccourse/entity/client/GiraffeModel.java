...
import net.forist.mccourse.entity.client.animation.CapybaraAnimations;
import net.forist.mccourse.entity.client.animation.GiraffeAnimations;
...
public class GiraffeModel<T extends GiraffeEntity> extends HierarchicalModel<T> {
    ...
    public void setupAnim(GiraffeEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        this.animateWalk(GiraffeAnimations.GIRAFFE_WALK, limbSwing, limbSwingAmount, 2f, 2.5f);
        this.animate(entity.idleAnimationState, GiraffeAnimations.GIRAFFE_IDLE, ageInTicks, 1f);
    }
