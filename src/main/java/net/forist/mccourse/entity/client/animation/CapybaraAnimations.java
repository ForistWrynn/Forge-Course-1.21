...
{
    public static final AnimationDefinition ANIM_CAPYBARA_IDLE = AnimationDefinition.Builder.withLength(2.0F).looping()
    ...
    public static final AnimationDefinition ANIM_CAPYBARA_WALK = AnimationDefinition.Builder.withLength(1.0F).looping()
